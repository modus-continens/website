...
},S=M("//","$"),A=M("/\\*","\\*/"),R=M("#","$");var j=Object.freeze({
...
BACKSLASH_ESCAPE:v,APOS_STRING_MODE:N,QUOTE_STRING_MODE:O,PHRASAL_WORDS_MODE:{
begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/
},COMMENT:M,C_LINE_COMMENT_MODE:S,C_BLOCK_COMMENT_MODE:A,HASH_COMMENT_MODE:R,
...
i=e,s=t),void 0===n&&(n=!0);const r={code:s,language:i};O("before:highlight",r)
;const o=r.result?r.result:_(r.language,r.code,n)
;return o.code=r.code,O("after:highlight",o),o}function _(e,n,i,r){
const c=Object.create(null);function l(){if(!N.keywords)return void M.addText(S)
;let e=0;N.keywordPatternRe.lastIndex=0;let t=N.keywordPatternRe.exec(S),n=""
;for(;t;){n+=S.substring(e,t.index)
;const i=y.case_insensitive?t[0].toLowerCase():t[0],r=(s=i,N.keywords[s]);if(r){
const[e,s]=r
;if(M.addText(n),n="",c[i]=(c[i]||0)+1,c[i]<=7&&(A+=s),e.startsWith("_"))n+=t[0];else{
const n=y.classNameAliases[e]||e;M.addKeyword(t[0],n)}}else n+=t[0]
;e=N.keywordPatternRe.lastIndex,t=N.keywordPatternRe.exec(S)}var s
;n+=S.substr(e),M.addText(n)}function g(){null!=N.subLanguage?(()=>{
if(""===S)return;let e=null;if("string"==typeof N.subLanguage){
if(!t[N.subLanguage])return void M.addText(S)
;e=_(N.subLanguage,S,!0,O[N.subLanguage]),O[N.subLanguage]=e._top
}else e=E(S,N.subLanguage.length?N.subLanguage:null)
...
;s?M.addKeyword(i,s):(S=i,l(),S=""),n++}}function h(e,t){
return e.scope&&"string"==typeof e.scope&&M.openNode(y.classNameAliases[e.scope]||e.scope),
e.beginScope&&(e.beginScope._wrap?(M.addKeyword(S,y.classNameAliases[e.beginScope._wrap]||e.beginScope._wrap),
S=""):e.beginScope._multi&&(u(e.beginScope,t),S="")),N=Object.create(e,{parent:{
value:N}}),N}function p(e,t,n){let i=((e,t)=>{const n=e&&e.exec(t)
...
return 0===N.matcher.regexIndex?(S+=e[0],1):(T=!0,0)}function b(e){
const t=e[0],s=n.substr(e.index),i=p(N,e,s);if(!i)return ee;const r=N
;N.endScope&&N.endScope._wrap?(g(),
M.addKeyword(t,N.endScope._wrap)):N.endScope&&N.endScope._multi?(g(),
u(N.endScope,e)):r.skip?S+=t:(r.returnEnd||r.excludeEnd||(S+=t),
g(),r.excludeEnd&&(S=t));do{
N.scope&&M.closeNode(),N.skip||N.subLanguage||(A+=N.relevance),N=N.parent
}while(N!==i.parent);return i.starts&&h(i.starts,e),r.returnEnd?0:t.length}
let m={};function w(t,r){const a=r&&r[0];if(S+=t,null==a)return g(),0
;if("begin"===m.type&&"end"===r.type&&m.index===r.index&&""===a){
if(S+=n.slice(r.index,r.index+1),!o){const t=Error(`0 width match regex (${e})`)
...
g(),n.returnBegin||n.excludeBegin||(S=t)),h(n,e),n.returnBegin?0:t.length})(r)
;if("illegal"===r.type&&!i){
const e=Error('Illegal lexeme "'+a+'" for mode "'+(N.scope||"<unnamed>")+'"')
;throw e.mode=N,e}if("end"===r.type){const e=b(r);if(e!==ee)return e}
...
;const x=F(y);let v="",N=r||x;const O={},M=new d.__emitter(d);(()=>{const e=[]
;for(let t=N;t!==y;t=t.parent)t.scope&&e.unshift(t.scope)
;e.forEach((e=>M.openNode(e)))})();let S="",A=0,R=0,j=0,T=!1;try{
for(N.matcher.considerAll();;){
j++,T?T=!1:N.matcher.considerAll(),N.matcher.lastIndex=R
;const e=N.matcher.exec(n);if(!e)break;const t=w(n.substring(R,e.index),e)
;R=e.index+t}return w(n.substr(R)),M.closeAllNodes(),M.finalize(),v=M.toHTML(),{
language:e,value:v,relevance:A,illegal:!1,_emitter:M,_top:N}}catch(t){
...
;return t._emitter.addText(e),t})(e),i=n.filter(k).filter(N).map((t=>_(t,e,!1)))
...
}),O("after:highlightElement",{el:e,result:r,text:s})}let y=!1;function x(){
...
i[e.toLowerCase()]=t}))}function N(e){const t=k(e)
...
},e.versionString="11.4.0",e.regex={concat:p,lookahead:g,either:f,optional:h,
...
},r,...s],illegal:""}},grmr_shell:e=>({name:"Shell Session",
aliases:["console","shellsession"],contains:[{className:"meta",
begin:/^\s{0,3}[/~\w\d[\]()@-]*[>%$#][ ]?/,starts:{end:/[^\\](?=\s*$)/,
subLanguage:"bash"}}]})});const se=te;for(const e of Object.keys(ne)){
